  ...
  return (
    <div className="flex md:items-center justify-between mt-1 p-4  md:p-8 h-20 w-screen lg:w-[82vw] shadow-2xl rounded-md">
      <div className="flex flex-col items-center">
        ...
        <h2 className="text-sm md:text-lg lg:text-2xl font-bold text-center text-logo">
          Login
        </h2>
      </div>
      ...
      <div className="flex flex-col items-center">
        ...
        <h2 className="text-sm md:text-lg lg:text-2xl font-bold text-center text-gray-300">
          Place Order
        </h2>
      </div>
    </div>
